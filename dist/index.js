...
function createProvider(ProviderOriginal) {
  return function (_ref) {
    ...
    return React__default.createElement(ProviderOriginal, {
...
function useReducer(_ref) {
  ...
  var reducerUpdated = React.useRef();
...
var connectWire = function connectWire(fuseName, Child) {
  return function (props) {
    ...
    return React.useMemo(function () {
      return React__default.createElement(Child, Object.assign({}, fuse, props));
    }, [props, context]);
  };
};
...
var Diffuse = function Diffuse(_ref3) {
  ...
  return React__default.createElement(DiffuseContext.Provider, {
    value: value
  }, children);
};
