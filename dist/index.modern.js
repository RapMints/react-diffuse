import React, { useState, useLayoutEffect, useRef, Suspense, useMemo } from 'react';
...
var StateMachine = /*#__PURE__*/function () {
  function StateMachine() {
      ...
      var create = function create(fuseBoxName, props) {
        ...
        var fuseBox = {
          ...
          useFetchState: function useFetchState(executor) {
            ...
            var diffusePromise = useRef();
            var initialState = useRef(null);
            useLayoutEffect(function () {
    ...
    this.useSelectionHook = function (store, selector) {
      ...
      var _useState4 = useState(selection),
...
var DiffuseBoundary = /*#__PURE__*/function (_React$Component) {
  ...
  function DiffuseBoundary(props) {
    ...
    _this.ErrorFallbackWrapper = function (_ref) {
      ...
      return (
        /*#__PURE__*/
        React.createElement(_this2.props.ErrorFallbackComponent, {
  ...
  _proto.render = function render() {
    if (this.state.hasError && this.state.error) {
      return (
        /*#__PURE__*/
        React.createElement(this.ErrorFallbackWrapper, {
...
export { DiffuseBoundary, createReducer, useActions, useDispatch, useFuse, useFuseSelection, useSelectors, wire };
